...
'* Version:        1.0
'*
'*  Main Function:  Enumerates the startup programs.
'*
'*  Startup.vbs.vbs [/S <server>] [/U <username>] [/W <password>] 
'*                  [/O <outputfile>]
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "Enumerates the startup programs on a machine."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  Startup.vbs [/S <server>] [/U <username>]" _
                &" [/W <password>]"
    ...
    Wscript.Echo "1. Startup.VBS"
    Wscript.Echo "   Lists startup programs on the current machine."
    Wscript.Echo "2. Startup.VBS /S MyMachine2"
    Wscript.Echo "   Lists startup programs on the machine MyMachine2."
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript Startup.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""Startup.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
