'********************************************************************
'*
'* File:           ProtocolBinding.vbs
'* Created:        March 1999
'* Version:        1.0
'*
'*  Main Function:  Lists Network Protocol Bindings on a machine.
'*
'*  ProtocolBinding.vbs [/S <server>] [/U <username>] [/W <password>] 
'*                      [/O <outputfile>]
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "Outputs Information on Protocol Bindings."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  ProtocolBinding.vbs [/S <server>] [/U <username>]" _
                &" [/W <password>]"
    ...
    Wscript.Echo "1. cscript ProtocolBinding.vbs"
    Wscript.Echo "   Get the binding configuration for the current machine."
    Wscript.Echo "2. cscript ProtocolBinding.vbs /S MyMachine2"
    Wscript.Echo "   Get the binding configuration for the machine MyMachine2."
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript ProtocolBinding.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""ProtocolBinding.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
