'********************************************************************
'*
'* File:           SystemAccount.vbs
'* Created:        March 1999
'* Version:        1.0
'*
'*  Main Function:  Displays System Account Information.
'*
'*  SystemAccount.vbs.vbs [/S <server>] [/U <username>] [/W <password>] 
'*                        [/O <outputfile>]
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "Displays System Account Information."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  SystemAccount.vbs [/S <server>] [/U <username>]" _
                &" [/W <password>]"
  ...
  Wscript.Echo "1. cscript SystemAccount.vbs"
  Wscript.Echo "   Get the system Account configuration for the" _
      & " current machine."
  Wscript.Echo "2. cscript SystemAccount.vbs /S MyMachine2"
  Wscript.Echo "   Get the system Account configuration for the " _
      & "machine MyMachine2."
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "    ""SystemAccount.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
