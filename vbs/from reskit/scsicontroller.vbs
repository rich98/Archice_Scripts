'********************************************************************
'*
'* File:           SCSIController.vbs
'* Created:        March 1999
'* Version:        1.0
'*
'*  Main Function:  Get the SCSI controller information on a machine.
'*
'*  SCSIController.vbs  [/S <server>] [/U <username>] [/W <password>] 
'*                      [/O <outputfile>]
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "Get the SCSI controller information on a machine."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  SCSIController.vbs [/S <server>] [/U <username>]" _
                &" [/W <password>]"
    ...
    Wscript.Echo "1. cscript SCSIController.vbs"
    Wscript.Echo "   Get the SCSI controller information for the " _
               & "current machine."
    Wscript.Echo "2. cscript SCSIController.vbs /S MyMachine2"
    Wscript.Echo "   Get the SCSI controller information for the " _
               & "machine MyMachine2."
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript ScsiController.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""ScsiController.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
