...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "Obtains the display configuration of a machine."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  ListDisplayConfig.VBS [/S <server>] [/U <username>]" _
                &" [/W <password>]"
    ...
    Wscript.Echo "1. ListDisplayConfig.vbs"
    Wscript.Echo "   Obtains the display configuration of the current machine."
    Wscript.Echo "2. ListDisplayConfig.vbs /S MyMachine2"
    Wscript.Echo "   Obtains the display confguration for the" _
               & " machine MyMachine2."
