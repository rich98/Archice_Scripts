...
'* Version:        1.0
'*
'*  Main Function:  Outputs Information on the Keyboard.
'*
'*  Keyboard.vbs    [/S <server>] [/U <username>] [/W <password>] 
'*                  [/O <outputfile>]
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "Outputs Information on the Keyboard."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  Keyboard.vbs [/S <server>] [/U <username>]" _
                &" [/W <password>]"
    ...
    Wscript.Echo "1. cscript Keyboard.vbs"
    Wscript.Echo "   Get the keyboard configuration for the current machine."
    Wscript.Echo "2. cscript Keyboard.vbs /S MyMachine2"
    Wscript.Echo "   Get the keyboard configuration for the machine MyMachine2."
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript KeyBoard.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""KeyBoard.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
