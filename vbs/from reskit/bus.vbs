...
'* Version:        1.0
'*
'*  Main Function:  Get the bus information for a machine.
'*
'*  Bus.vbs  [/S <server>] [/U <username>] [/W <password>]
'*           [/O <outputfile>]
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "Get the bus information for a machine."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  Bus.vbs [/S <server>] [/U <username>] [/W <password>]"
    ...
    Wscript.Echo "1. cscript Bus.vbs"
    Wscript.Echo "   Get the bus information for the current machine."
    Wscript.Echo "2. cscript Bus.vbs /S MyMachine2"
    Wscript.Echo "   Get the bus information for the machine MyMachine2."
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript bus.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""bus.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
