...
'*
'*  TapeDrive.vbs      [/S <server>] [/U <username>] [/W <password>] 
'*                     [/O <outputfile>]
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "Outputs Information on Disk Drives."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  TapeDrive.vbs [/S <server>] [/U <username>]" _
                &" [/W <password>]"
    ...
    Wscript.Echo "1. cscript TapeDrive.vbs"
    Wscript.Echo "   Gets tape drive information for the current machine."
    Wscript.Echo "2. cscript TapeDrive.vbs /S MyMachine2"
    Wscript.Echo "   Gets tape drive information for the machine MyMachine2."
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript TapeDrive.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""TapeDrive.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
