...
'* Version:        1.0
'*
'*  Main Function:  List the properties of a computer system.
'*
'*  CompSys.vbs [/S <server>] [/U <username>] [/W <password>] 
'*              [/O <outputfile>]
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "List the properties of a computer system."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  CompSys.vbs [/S <server>] [/U <username>]" _
               & " [/W <password>]"
    ...
    Wscript.Echo "1. cscript CompSys.vbs"
    Wscript.Echo "   List the properties of a computer system for the " _
               & "current machine."
    Wscript.Echo "2. cscript CompSys.vbs /S MyMachine2"
    Wscript.Echo "   List the properties of a computer system for the " _
              & "machine MyMachine2."
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript CompSys.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""CompSys.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
