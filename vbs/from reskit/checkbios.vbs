...
'* Version:        1.0
'*
'*  Main Function:  Displays information on system BIOS.
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  CheckBios.vbs [/S <server>] [/U <username>]" _
                &" [/W <password>]"
    ...
    Wscript.Echo "1. cscript CheckBios.vbs"
    Wscript.Echo "   Get the bios information for the current machine."
    Wscript.Echo "2. cscript CheckBios.vbs /S MyMachine2"
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript CheckBios.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""CheckBios.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
