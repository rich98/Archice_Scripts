'********************************************************************
'*
'* File:           ListFreeSpace.vbs
'* Created:        March 1999
'* Version:        1.0
'*
'*  Main Function:  Lists available disk space on all drives of a machine.
'*
'*  ListFreeSpace.vbs      [/S <server>] [/U <username>] [/W <password>] 
'*                         [/O <outputfile>]
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "Lists available disk space on all drives of a machine."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  ListFreeSpace.vbs [/S <server>] [/U <username>]" _
                &" [/W <password>]"
    ...
    Wscript.Echo "   1.  ListFreeSpace.vbs"
    Wscript.Echo "   Lists available space on all local drives."
    Wscript.Echo "   2.  ListFreeSpace.vbs /S MyMachine2"
    Wscript.Echo "   Lists available space on all drives of MyMachine2."
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript ListFreeSpace.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""ListFreeSpace.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
