...
' Abstract:
'
' drvmgr.vbs - driver script for Windows 2000
'
' Usage:
...
'
' Example:
' drvmgr -d -m "driver" -v "Windows 2000" -t Intel
' drvmgr -l -c \\server
'----------------------------------------------------------------------
...
sub Usage(bExit)
    ...
    wscript.echo "drvmgr -a -m ""driver"" -v ""Windows 2000"" -t Intel"
    wscript.echo "drvmgr -d -m ""driver"" -v ""Windows 2000"" -t Intel"
