...
'* Version:        1.0
'*
'*  Main Function:  List the desktop properties on a system.
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "List the desktop properties on a system."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  DeskTop.vbs [/S <server>] [/U <username>]" _
                &" [/W <password>]"
    ...
    Wscript.Echo "1. cscript DeskTop.vbs"
    Wscript.Echo "   List the desktop properties for the current machine."
    Wscript.Echo "2. cscript DeskTop.vbs /S MyMachine2"
    Wscript.Echo "   List the desktop properties for the machine MyMachine2."
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript DeskTop.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""DeskTop.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
