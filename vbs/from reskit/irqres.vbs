...
'* Version:        1.0
'*
'*  Main Function:  Outputs IRQ information.
'*
'*  IrqRes.vbs       [/S <server>] [/U <username>] [/W <password>] 
'*                   [/O <outputfile>]
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "Outputs IRQ information."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  IrqRes.vbs [/S <server>] [/U <username>]" _
                &" [/W <password>]"
    ...
    Wscript.Echo "1. cscript IRQres.vbs"
    Wscript.Echo "   Lists IRQ resource information for the current machine."
    Wscript.Echo "2. cscript IRQres.vbs /S MyMachine2"
    Wscript.Echo "   Lists IRQ resource information for the machine MyMachine2."
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript Irq.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""IrqRes.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
