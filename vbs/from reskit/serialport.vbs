...
'* Version:        1.0
'*
'*  Main Function:  Outputs the serial port configurations.
'*
'*  SerialPort.vbs.vbs [/S <server>] [/U <username>] [/W <password>] 
'*                     [/O <outputfile>]
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "Outputs the serial port configurations."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  SerialPort.vbs [/S <server>] [/U <username>]" _
                &" [/W <password>]"
    ...
    Wscript.Echo "1. cscript SerialPort.vbs"
    Wscript.Echo "   Lists the computer's serial port configurations " _
               & "for the current machine."
    Wscript.Echo "2. cscript SerialPort.vbs /S MyMachine2"
    Wscript.Echo "   Lists the computer's serial port configurations " _
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript SerialPort.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""SerialPort.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
