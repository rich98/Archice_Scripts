...
'*
'*  Processor.vbs      [/S <server>] [/U <username>] [/W <password>] 
'*                     [/O <outputfile>]
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "Gets CPU information for a machine."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  Processor.vbs [/S <server>] [/U <username>]" _
                &" [/W <password>]"
    ...
    Wscript.Echo "1. cscript Processor.vbs"
    Wscript.Echo "   Gets CPU information for the current machine."
    Wscript.Echo "2. cscript Processor.vbs /S MyMachine2"
    Wscript.Echo "   Gets CPU information for the machine MyMachine2."
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript Processor.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""Processor.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
