'********************************************************************
'*
'* File:           DiskPartition.vbs
'* Created:        March 1999
'* Version:        1.0
'*
'*  Main Function:  Get the disk partition information of a machine.
'*
'*  DiskPartition.vbs [/S <server>] [/U <username>] [/W <password>] 
'*                    [/O <outputfile>]
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "Get the disk partition information of a machine."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  DiskPartition.vbs [/S <server>] [/U <username>]" _
                &" [/W <password>]"
    ...
    Wscript.Echo "1. cscript DiskPartition.vbs"
    Wscript.Echo "   Get the disk partition information of the current machine."
    Wscript.Echo "2. cscript DiskPartition.vbs /S MyMachine2"
    Wscript.Echo "   Get the disk partition information of " _
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript DiskPartition.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""DiskPartition.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
