'********************************************************************
'*
'* File:           ParallelPort.vbs
'* Created:        March 1999
'* Version:        1.0
'*
'*  Main Function:  Get the parallel port information for a machine.
'*
'*  ParallelPort.vbs      [/S <server>] [/U <username>] [/W <password>] 
'*                        [/O <outputfile>]
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "Get the parallel port information for a machine."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  ParallelPort.vbs [/S <server>] [/U <username>]" _
                &" [/W <password>]"
    ...
    Wscript.Echo "1. cscript ParallelPort.vbs"
    Wscript.Echo "   Get the parallel port information for the current machine."
    Wscript.Echo "2. cscript ParallelPort.vbs /S MyMachine2"
    Wscript.Echo "   Get the parallel port information for " _
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript Parallelport.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""Parallelport.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
