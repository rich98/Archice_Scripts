...
'* Version:        1.0
'*
'*  Main Function:  Displays Boot Configuration Information.
'*
...
Sub ShowUsage ()
    ...
    Wscript.Echo ""
    Wscript.Echo "Displays Boot Configuration Information."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  BootConfig.vbs [/S <server>] [/U <username>]"
    ...
    Wscript.Echo "1. cscript BootConfig.vbs"
    Wscript.Echo "   Get the boot configuration for the current machine."
    Wscript.Echo "2. cscript BootConfig.vbs /S MyMachine2"
    Wscript.Echo "   Get the boot configuration for the machine MyMachine2."
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript bootconfig.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""BootConfig.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
