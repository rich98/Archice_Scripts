...
'* Version:        1.0
'*
'*  Main Function:  Lists total disk space on all drives of a machine.
'*
'*  ListSpace.vbs      [/S <server>] [/U <username>] [/W <password>] 
'*                     [/O <outputfile>]
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "Lists total disk space on all drives of a machine."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  ListSpace.vbs [/S <server>] [/U <username>]" _
                &" [/W <password>]"
    ...
    Wscript.Echo "1. ListSpace.vbs"
    Wscript.Echo "   Lists the total space on all local drives."
    Wscript.Echo "2. ListSpace.vbs /S:MyMachine2"
    Wscript.Echo "   Lists the total space on all drives of MyMachine2."
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript ListSpace.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""ListSpace.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
