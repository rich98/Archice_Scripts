...
'* Version:        1.0
'*
'*  Main Function:  Get the cache information for a machine.
'*
'*  CacheInfo.vbs  [/S <server>] [/U <username>] [/W <password>] 
'*                 [/O <outputfile>]
'*
...
Private Sub GetCacheInfo(strServer, strOutputFile, strUserName, strPassword)
    ...
    For Each objCache In objCacheSet
        Select Case objCache.ErrorCorrectType
            Case 0
                strErrorCorrectType = "Reserved"
            Case 1
                strErrorCorrectType = "Other"
            Case 2
                strErrorCorrectType = "Unknown"
            Case 3
                strErrorCorrectType = "None"
            Case 4
                strErrorCorrectType = "Parity"
            Case 5
                strErrorCorrectType = "Single-bit ECC"
            Case 6
                strErrorCorrectType = "Multi-bit ECC"
        End Select
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "Get the cache information for a machine."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  CacheInfo.vbs [/S <server>] [/U <username>]" _
                &" [/W <password>]"
    ...
    Wscript.Echo "1. cscript CacheInfo.vbs"
    Wscript.Echo "   Get the cache information for the current machine."
    Wscript.Echo "2. cscript CacheInfo.vbs /S MyMachine2"
    Wscript.Echo "   Get the cache information for the machine MyMachine2."
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript cacheinfo.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""CacheInfo.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
