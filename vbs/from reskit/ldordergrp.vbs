...
'* Version:        1.0
'*
'*  Main Function:  List the service dependency groups on a machine.
'*
'*  LdOrderGrp.vbs      [/S <server>] [/U <username>] [/W <password>] 
'*                      [/O <outputfile>]
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "List the service dependency groups on a machine."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  LdOrderGrp.vbs [/S <server>] [/U <username>]" _
                &" [/W <password>]"
    ...
    Wscript.Echo "1. cscript LdOrderGrp.vbs"
    Wscript.Echo "   List the service dependency groups for the current machine."
    Wscript.Echo "2. cscript LdOrderGrp.vbs /S MyMachine2"
    Wscript.Echo "   List the service dependency groups for the machine MyMachine2."
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript LdOrderGrp.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""LdOrderGrp.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
