'********************************************************************
'*
'* File:           SoundDevice.vbs
'* Created:        March 1999
'* Version:        1.0
'*
'*  Main Function:  Get the sound device configuration of a machine.
'*
'*  SoundDevice.vbs    [/S <server>] [/U <username>] [/W <password>] 
'*                     [/O <outputfile>]
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "List the sound device properties on a machine."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  SoundDevice.vbs [/S <server>] [/U <username>]" _
                &" [/W <password>]"
    ...
    Wscript.Echo "1. cscript SoundDevice.vbs"
    Wscript.Echo "   List the sound device properties for the current machine."
    Wscript.Echo "2. cscript SoundDevice.vbs /S MyMachine2"
    Wscript.Echo "   List the sound device properties for the " _
               & "machine MyMachine2."
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript SoundDevice.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""SoundDevice.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
