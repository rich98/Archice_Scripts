'********************************************************************
'*
'* File:           LstDpConInfo.Vbs
'* Created:        December 1998
'* Version:        1.0
'*
'*  Main Function:  Obtains the display controllor information of a machine.
'*
'*  LstDpConInfo.vbs [/S <server>] [/U <username>] [/W <password>] 
'*                   [/O <outputfile>]
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "Obtains the display controllor information of a machine."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  LstDpConInfo.vbs [/S <server>] [/U <username>]" _
               & " [/W <password>]"
    ...
    Wscript.Echo "1. cscript LstDpConInfo.vbs"
    Wscript.Echo "   Obtains display controllor information of the " _
               & "current machine."
    Wscript.Echo "2. cscript LstDpConInfo.vbs /S MyMachine2"
    Wscript.Echo "   Obtains display controllor information for the " _
               & "machine MyMachine2."
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript LstDpConInfo.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""LstDpConInfo.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
