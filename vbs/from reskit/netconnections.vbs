'********************************************************************
'*
'* File:           NetConnections.vbs 
'* Created:        March 1999
'* Version:        1.0
'*
'*  Main Function:  Lists Selected Properties of Network Connections.
'*
'*  NetConnections.vbs [/S <server>] [/U <username>] [/W <password>] 
'*              [/O <outputfile>]
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "Lists Selected Properties of Network Connections."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  NetConnections.vbs [/S <server>] [/U <username>]" _
               & " [/W <password>]"
    ...
    Wscript.Echo "1. cscript NetConnections.vbs"
    Wscript.Echo "   List network connections for the " _
               & "current machine."
    Wscript.Echo "2. cscript NetConnections.vbs /S MyMachine2"
    Wscript.Echo "   List network connections for the " _
              & "machine MyMachine2."
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript NetConnections.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""NetConnections.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
