'********************************************************************
'*
'* File:           ListAdapters.vbs
'* Created:        March 1999
'* Version:        1.0
'*
'*  Main Function:  Lists properties of all network adapters.
'*
'*  ListAdapters.vbs [/S <server>] [/U <username>] [/W <password>] 
'*                   [/O <outputfile>]
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "Lists properties of all network adapters."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  ListAdapters.vbs [/S <server>] [/U <username>]" _
                &" [/W <password>]"
    ...
    Wscript.Echo "1. cscript ListAdapters.vbs"
    Wscript.Echo "   List the network adapters on the local machine."
    Wscript.Echo "2. cscript ListAdapters.vbs /S MyMachine2"
    Wscript.Echo "   List the network adapters on the machine MyMachine2."
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript ListAdapters.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""ListAdapters.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
