'********************************************************************
'*
'* File:           CDRomDrives.vbs 
'* Created:        March 1999
'* Version:        1.0
'*
'*  Main Function:  Outputs Information on CDRomDrives.
'*
'*  CDRomDrives.vbs  [/S <server>] [/U <username>] [/W <password>] 
'*                   [/O <outputfile>]
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "Outputs Information on CD-ROM Drives."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  CDRomDrives.vbs [/S <server>] [/U <username>]" _
                &" [/W <password>]"
    ...
    Wscript.Echo "1. cscript CdRomDrives.vbs"
    Wscript.Echo "   Get the CD-ROM configuration for the current machine."
    Wscript.Echo "2. cscript CdRomDrives.vbs /S MyMachine2"
    Wscript.Echo "   Get the CD-ROM configuration for the machine MyMachine2."
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript CdRomDrives.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""CdRomDrives.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
