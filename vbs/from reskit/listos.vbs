...
'* Version:        1.0
'*
'*  Main Function:  Lists properties of the operating system on a machine.
'*
'*  ListOs.vbs      [/S <server>] [/U <username>] [/W <password>] 
'*                  [/O <outputfile>]
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "Lists properties of the operating system on a machine."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    ...
    Wscript.Echo "1. cscript ListOs.vbs"
    Wscript.Echo "   List operating system information for the current machine."
    Wscript.Echo "2. cscript ListOs.vbs /S MyMachine2"
    Wscript.Echo "   List operating system information for the machine MyMachine2."
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript ListOs.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""ListOs.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
