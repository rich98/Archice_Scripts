...
'* Version:        1.0
'*
'*  Main Function:  Get the pointing device information for a machine.
'*
'*  DeskTop.vbs      [/S <server>] [/U <username>] [/W <password>] 
'*                   [/O <outputfile>]
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "Get the pointing device information for a machine."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  PointDev.vbs [/S <server>] [/U <username>]" _
                &" [/W <password>]"
    ...
    Wscript.Echo "1. cscript PointDev.vbs"
    Wscript.Echo "   List the pointing device properties for the current machine."
    Wscript.Echo "2. cscript PointDev.vbs /S MyMachine2"
    Wscript.Echo "   List the pointing device properties for the " _
               & "machine MyMachine2."
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript Pointdev.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""Pointdev.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
