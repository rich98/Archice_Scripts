...
'* Version:        1.0
'*
'*  Main Function:  List the DMA channels on a machine.
'*
'*  DmaChan.vbs      [/S <server>] [/U <username>] [/W <password>] 
'*                   [/O <outputfile>]
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "List the DMA channels on a machine."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  DmaChan.vbs [/S <server>] [/U <username>] [/W <password>]"
    ...
    Wscript.Echo "1. cscript DMAchan.vbs"
    Wscript.Echo "   List the DMA channels for the current machine."
    Wscript.Echo "2. cscript DMAchan.vbs /S MyMachine2"
    Wscript.Echo "   List the DMA channels for the machine MyMachine2."
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript DmaChan.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""DmaChan.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
