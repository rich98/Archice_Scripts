...
' Abstract:
'
' prnmgr.vbs - printer script for Windows 2000
'
' Usage:
...
function DelPrinterConnectionAll()
    ...
    wscript.echo "Number of connection found " & iTotal & ". Connections deleted " & iCount
...
sub Usage(bExit)
    ...
    wscript.echo "-b     - print name"
    wscript.echo "-m     - driver model"
    wscript.echo "-r     - port name"
    wscript.echo "-p     - dirver path can be local or network path i.e. a:\ or \\server\share"
