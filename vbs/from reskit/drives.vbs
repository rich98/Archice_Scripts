...
'* Version:        1.0
'*
'*  Main Function:  Outputs Information on Physical Disk Drives.
'*
'*  Drives.vbs  [/S <server>] [/U <username>] [/W <password>] 
'*              [/O <outputfile>]
'*
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "Outputs Information on Physical Disk Drives."
    Wscript.Echo ""
    Wscript.Echo "SYNTAX:"
    Wscript.Echo "  Drives.vbs [/S <server>] [/U <username>]" _
                &" [/W <password>]"
    ...
    Wscript.Echo "1. cscript Drives.vbs"
    Wscript.Echo "   Get the drive configuration for the current machine."
    Wscript.Echo "2. cscript Drives.vbs /S MyMachine2"
    Wscript.Echo "   Get the drive configuration for the machine MyMachine2."
...
Sub VerifyHostIsCscript()
    ...
    If intStatus <> CONST_CSCRIPT Then
        Call WScript.Echo( "Please run this script using CScript." & vbCRLF & _
             ...
             "1. Using ""CScript Drives.vbs arguments"" for Windows 95/98 or" _
             ...
             "    ""Drives.vbs arguments"" for Windows NT/2000." )
        WScript.Quit
    End If
